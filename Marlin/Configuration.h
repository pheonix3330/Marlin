...
#define STRING_CONFIG_H_AUTHOR "(Eddie C, Ender 3 for SKR Mini E3 V2.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR E3 V2"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, 17.6, 0 }
